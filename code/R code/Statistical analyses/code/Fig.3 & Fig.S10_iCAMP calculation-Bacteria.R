...
wd="/data2/zhuhh/Saline-alkali_soil/Bacteria/out/iCAMP2/input/"

# the OTU table file (Tab delimited txt file)
com.file="otu_bacteriaFlattening.csv"

# the phylogenetic tree file
tree.file="16.iCAMP.nwk"

# the classification (taxonomy) information
clas.file="HMME.bact.OTU.ID1.csv"
...
save.wd="/data2/zhuhh/Saline-alkali_soil/Bacteria/out/iCAMP2/output/"
if(!dir.exists(save.wd)){dir.create(save.wd)}

# 2 # key parameter setting
prefix="Bacteria"  # prefix of the output file names. usually use a project ID.
