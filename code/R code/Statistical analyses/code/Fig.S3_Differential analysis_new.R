...
# transform PvalueΪ as negative logarithm
...
p <-  
  ...
  labs(x=NULL, y = bquote(bold(-log[10]*"("*italic("P")*")")),title=Title, size="Abundance (%)", shape ="Contrast") +  # ɾ??x????ǩ
  theme_classic() + 
  theme(
...
saveRDS(p_bac1,"E:/Saline-alkali soil/Saline-alkali/amplicon/result-U/Figures/diffenertial/bac1.rda")
saveRDS(p_bac2,"E:/Saline-alkali soil/Saline-alkali/amplicon/result-U/Figures/diffenertial/bac2.rda")
