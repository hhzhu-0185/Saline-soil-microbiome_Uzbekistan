...
my_amfbarplot <- function(a, legend, path) {
  ...
  genus_top10['Others', ][, 2:26] <-1 - colSums(genus_top10[, 2:26])  # 1减去前十的百分比
...
my_bacbarplot(0, "Phylum","Prokaryotes", "./taxonomy/bac-Phylum-barplot.pdf")
p_bac_phylum <- p1
genus_tttop10 <- aggregate(value ~ Taxonomy, data = genus_tttop10, FUN = "mean")
print(genus_tttop10)
my_bacbarplot(1, "Class", "Prokaryotes","./taxonomy/bac-Class-barplot.pdf")
my_bacbarplot(2, "Order", "Prokaryotes","./taxonomy/bac-Order-barplot.pdf")
my_bacbarplot(3, "Family", "Prokaryotes","./taxonomy/bac-Family-barplot.pdf")
my_bacbarplot(4, "Genus", "Prokaryotes","./taxonomy/bac-Genus-barplot2.pdf")
p_bac_genus <- p1
my_bacbarplot(5, "Species", "Prokaryotes","./taxonomy/bac-Species-barplot.pdf")
...
### 4.Protist
rm(list = setdiff(ls(), c("p_amf_class", "p_amf_genus", "p_bac_phylum", "p_bac_genus","p_fung_class", "p_fung_genus")))
...
saveRDS(p_fung_class,"E:/Saline-alkali soil/Saline-alkali/amplicon/result-U/Figures/taxonomy/fung_class.rda")
