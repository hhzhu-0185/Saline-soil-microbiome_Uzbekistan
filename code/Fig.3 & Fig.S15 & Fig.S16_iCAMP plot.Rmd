---
title: "Fig.3 & Fig.S15 & Fig.S16_iCAMP plot"
author: "Huanhuan Zhu"
date: "2025-02-17"
...
#############################################Fig.3 & Fig.S15 & Fig.S16_iCAMP plot#########################################
...
p2_amf <- ggplot(data=result_all2,aes(x = factor(Group, levels = c("CK","JP","CL","MH","YM")), y = as.numeric(value),fill = factor(variable))) +
  geom_col(width = 0.6) +
  geom_text(data=result_all2[result_all2$value >0.01,],aes(label=paste0(round(value*100),"%"), color=factor(variable)),
