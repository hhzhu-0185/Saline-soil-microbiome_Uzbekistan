...
wd="/data2/zhuhh/Saline-alkali_soil/AMF/out/iCAMP2/input/"

# the OTU table file (Tab delimited txt file)
com.file="otu_amfFlattening.csv"

# the phylogenetic tree file
tree.file="amf.iCAMP.nwk"

# the classification (taxonomy) information
clas.file="HMME.amf.OTU.ID1.csv"
...
save.wd="/data2/zhuhh/Saline-alkali_soil/AMF/out/iCAMP2/output/"
if(!dir.exists(save.wd)){dir.create(save.wd)}

# 2 # key parameter setting
prefix="AMF"  # prefix of the output file names. usually use a project ID.
