...
fungi.network<-function(k, para){
  ...
  #percent transfer
  data0<-data.frame(t((apply(otu_all,2,function(x){x / sum(x)}))),check.names = FALSE)#2 indicates cols; ???傻???OTU为col????品为row
